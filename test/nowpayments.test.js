...
import { canonicalNowPaymentsPayload, createNowPayment, isNowPaymentsFinished, nowPaymentsReady, verifyNowPaymentsIpn } from '../src/payments/nowpayments.js';

test('NOWPayments is disabled until API key, IPN secret and callback are all configured', () => {
