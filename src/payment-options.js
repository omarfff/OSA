const DEFAULTS = Object.freeze({
  ...
  solana: "5JwtYANBUcCXiWxJtgyNDYxiKtYjpwd349xRF2mMSyN1",
...
export function paymentOptions() {
  ...
  const solana = addr("OSA_SOLANA_RECEIVE_ADDRESS", DEFAULTS.solana);
  ...
  return {
    ...
    directCrypto: [
      ...
      { network: "Solana", caip2: "solana:5eykt4UsFv8P8NJdTREpY1vzqKqZKvdp", assets: ["USDC", "USDT", "SOL"], address: solana },
